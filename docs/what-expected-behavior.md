...
玩家在固定的陆行舰上活动，通过移动、接管炮台、购买藏品、承受并击退敌方波次，完成一个 3 章结构的路线推进流程。流程中包含：
...
- 点击开始新游戏后，应完成基础状态初始化，包括货币、章节、击杀数、升级状态等，并进入地图选择界面。
...
- 波间期应自动打开综合信息界面，并暂停当前战场时间流逝。
- 波间期应支持以下动作：
  - 继续下一波；
  - 修理船体；
  - 在整备子页执行波间升级；
  - 浏览本局藏品与地图信息。
- 战斗进行中也应允许打开该综合信息界面；此时游戏同样暂停，但整备操作必须只读，不可执行维修或升级购买。
- 波间期结束后，应能正常继续后续战斗，而不是卡死在中间状态。

### 4. 战斗结束逻辑

- 非最终章战斗全部完成后，应返回地图推进流程。
- 最终章战斗完成后，应触发胜利。
...
- 战斗中按 Tab 应打开综合信息界面，并暂停当前战斗时间流逝。
- 综合信息界面应至少包含三个可点击切换的子页：整备、藏品、地图。
- 主动战斗中，整备子页只能浏览当前舰船状态、升级状态与下一波信息，不能执行维修或升级购买。
- 波间期打开时，整备子页应允许继续下一波、修理船体和购买波间升级。
- 全部波次完成时应显示战斗完成状态。
